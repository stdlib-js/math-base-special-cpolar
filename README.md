...
The function computes the [absolute value][absolute-value] and [phase][complex-number-argument] of a complex number

<!-- <equation class="equation" label="eq:cpolar_function" align="center" raw="z = r e^{i\theta}" alt="Complex polar form"> -->

```math
z = r e^{i\theta}
```

<!-- <div class="equation" align="center" data-raw-text="z = r e^{i\theta}" data-equation="eq:cpolar_function">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@85f48534ef6908bbcd982d48f1c5fbea3fb7aafd/lib/node_modules/@stdlib/math/base/special/cpolar/docs/img/equation_cpolar_function.svg" alt="Complex polar form">
    <br>
</div> -->

<!-- </equation> -->

where `r = |z|` is the absolute value (modulus) and `θ` is the phase (argument).
...
[complex-number-argument]: https://en.wikipedia.org/wiki/Argument_(complex_analysis)
